  ...
  return (
    <div className="relative h-screen">
      ...
      <div className="flex justify-center items-center min-h-screen p-4">
        <div className="w-full max-w-sm sm:max-w-md md:max-w-lg p-4">
          <form
            onSubmit={handleSubmit(onSubmit)}
            className="flex flex-col gap-y-4 rounded-md border p-6 bg-white/80 shadow-lg"
          >
            <input
              {...register("name")}
            ...
            <input type="submit" className="rounded-md bg-blue-500 py-2 text-white cursor-pointer hover:bg-blue-600 transition-colors" />
